      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-400 mb-8">
            Accede a tu panel de control y gestiona tu negocio de manera eficiente
          </p>
        ...
        >
          <Card className="border-neutral-200 dark:border-neutral-800 shadow-xl">
            <CardHeader>
              <CardTitle className="text-2xl text-neutral-900 dark:text-white">Iniciar Sesión</CardTitle>
